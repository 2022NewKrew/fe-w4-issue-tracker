...
const App = () => {
  return (
    <>
      <Button type={ BUTTON_TYPE.LARGE_STANDARD } text="BUTTON" onClickListener={ () => {
        console.log('clicked')
      } } />
      <Button type={ BUTTON_TYPE.MEDIUM_STANDARD } text="BUTTON" onClickListener={ () => {
        console.log('clicked')
      } } />
      <Button type={ BUTTON_TYPE.SMALL_STANDARD } text="BUTTON" onClickListener={ () => {
        console.log('clicked')
      } } />
      <Button type={ BUTTON_TYPE.SMALL_SECONDARY } text="BUTTON" onClickListener={ () => {
        console.log('clicked')
      } } />
      <Button type={ BUTTON_TYPE.MEDIUM_TEXT } text="BUTTON" onClickListener={ () => {
        console.log('clicked')
      } } />
      <Button type={ BUTTON_TYPE.SMALL_TEXT } text="BUTTON" onClickListener={ () => {
        console.log('clicked')
      } } />
