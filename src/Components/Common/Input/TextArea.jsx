...
import { ReactComponent as AttachIcon } from '../../../icon/ic-paperclip.svg'
...
const TextArea = ({
  ...
  const [ isPassedTwoSecondsAfterTyping, setIsPassedTwoSecondsAfterTyping ] = useState(false)
  
  const onInputValueChange = useCallback((inputValue, setInputValue) => {
