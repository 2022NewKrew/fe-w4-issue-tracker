...
const Button = ({
  ...
  const customStyle = useMemo(() => {
    ...
    style =
      type === BUTTON_TYPE.STANDARD
        ...
        ? style.concat(secondaryBtnStyle)
        : type === BUTTON_TYPE.TEXT
        ? style.concat(textBtnStyle)
        : style.concat(standardBtnStyle)
    ...
    if (isDisabled) {
      ...
      style =
        type === BUTTON_TYPE.STANDARD
          ...
          : type === BUTTON_TYPE.SECONDARY
          ? style.concat(secondaryBtnInteractionStyle)
          : type === BUTTON_TYPE.TEXT
          ? style.concat(textBtnInteractionStyle)
          : style.concat(standardBtnInteractionStyle)
    }
  ...
  return (
    <Btn onClick={onClick} customStyle={customStyle}>
      {children}
    </Btn>
  )
}
